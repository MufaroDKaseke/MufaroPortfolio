        ...
        <div class="row flex-column flex-sm-row align-items-center justify-content-center justify-content-sm-between">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active text-capitalize" aria-current="page"><?php echo $category;?></li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <section class="blog">
      <div class="container">
          ...
          <div class="col-12 col-lg-8 blog-entries row">
            ...
            <div class="col-12">
              <h5 class="blog-title">Category : <span class="text-capitalize"><?php echo $category;?></span></h5>
            </div>
